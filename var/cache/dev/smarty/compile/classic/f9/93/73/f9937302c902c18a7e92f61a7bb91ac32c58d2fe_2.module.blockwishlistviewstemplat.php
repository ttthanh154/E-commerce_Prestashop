...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_63a40283349936_64127203',
...
function content_63a40283349936_64127203 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- begin C:\xampp\htdocs\pretashop/modules/blockwishlist/views/templates/components/modals/delete.tpl -->
<div
  class="wishlist-delete"
  <?php if ((isset($_smarty_tpl->tpl_vars['listUrl']->value))) {?>
    data-delete-list-url="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['listUrl']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
"
  <?php }?>
  <?php if ((isset($_smarty_tpl->tpl_vars['deleteProductUrl']->value))) {?>
    data-delete-product-url="<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['deleteProductUrl']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
"
  <?php }?>
...
<!-- end C:\xampp\htdocs\pretashop/modules/blockwishlist/views/templates/components/modals/delete.tpl --><?php }
}
