    ...
    {if $input.type == 'link_blocks'}
        <div class="row">
            <script type="text/javascript">
                var come_from = '{$name_controller|escape:'html':'UTF-8'}';
                ...
                <div class="col-lg-6">
                    <div class="panel">
                        <div class="panel-heading">
                            {$link_blocks_position.hook_name|escape:'html':'UTF-8'}
                             <small>{$link_blocks_position.hook_title|escape:'html':'UTF-8'}</small>
                        </div>
                                        ...
                                        <td>
                                            <div class="btn-group-action">
                                                <div class="btn-group pull-right">
                                                    <a class="btn btn-default" href="{$current|escape:'html':'UTF-8'}&amp;edit{$identifier|escape:'html':'UTF-8'}&amp;id_link_block={(int)$link_block['id_link_block']}" title="{l s='Edit' d='Modules.Linklist.Admin'}">
                                                    ...
                                                    <li>
                                                        <a href="{$current|escape:'html':'UTF-8'}&amp;delete{$identifier|escape:'html':'UTF-8'}&amp;id_link_block={(int)$link_block['id_link_block']}" title="{l s='Delete' d='Modules.Linklist.Admin'}">
    ...
    {foreach $input.values as $cms_category}
      <div class="row">
        <div class="col-lg-9 col-lg-offset-3">
          <div class="panel">
            <div class="panel-heading">
              {$input.label|escape:'html':'UTF-8'} - {$cms_category.name|escape:'html':'UTF-8'}
            </div>
            <table class="table">
              <thead>
                <tr>
              ...
              <tbody>
                {foreach $cms_category.pages as $key => $page}
                  <tr {if $key%2}class="alt_row"{/if}>
                    <td>
                      <input type="checkbox" class="cmsBox" name="{$input.name|escape:'html':'UTF-8'}" id="{$page.id_cms|escape:'html':'UTF-8'}" value="{$page.id_cms|escape:'html':'UTF-8'}" {if in_array($page.id_cms, $fields_value['content']['cms'])}checked="checked"{/if} />
                    </td>
                    <td class="fixed-width-xs">
                      {$page.id_cms|escape:'html':'UTF-8'}
                    </td>
                    <td>
                      <label class="control-label" for="{$page.id_cms|escape:'html':'UTF-8'}">
                        {$page.title|escape}
                      </label>
                    </td>
                  </tr>
                    ...
                    <tr {if $key%2}class="alt_row"{/if}>
                      <td>
                        {if $input.type == 'product_pages'}
                          <input type="checkbox" class="cmsBox" name="{$input.name|escape:'html':'UTF-8'}" id="{$page.id_cms|escape:'html':'UTF-8'}" value="{$page.id_cms|escape:'html':'UTF-8'}" {if in_array($page.id_cms, $fields_value['content']['product'])}checked="checked"{/if} />
                        {elseif $input.type == 'static_pages'}
                          <input type="checkbox" class="cmsBox" name="{$input.name|escape:'html':'UTF-8'}" id="{$page.id_cms|escape:'html':'UTF-8'}" value="{$page.id_cms|escape:'html':'UTF-8'}" {if in_array($page.id_cms, $fields_value['content']['static'])}checked="checked"{/if} />
                        {/if}
                      </td>
                      <td>
                        <label class="control-label" for="{$page.id_cms|escape:'html':'UTF-8'}">
      ...
      {foreach $languages as $lang}
        <div class="row">
          <div class="col-lg-9 col-lg-offset-3">
            <div class="panel">
              <div class="panel-heading">
                {$input.label|escape:'html':'UTF-8'} - {$lang['name']}
              </div>
              <table class="table js-custom-links-table-{$lang['id_lang']}">
                ...
                {foreach $input.values[$lang['id_lang']] as $key => $page}
                  <tr {if $key%2}class="alt_row"{/if} data-item="{$key|escape:'html':'UTF-8'}">
                    <td><a href="#" class="js-clear-custom-link"><i class="material-icons action-disabled">{l s='Clear' d='Admin.Actions'}</i></a></td>
                    <td>
                      <label class="control-label">
                        <input type="text" name="custom[{$lang['id_lang']}][{$key|escape:'html':'UTF-8'}][title]" value="{$page.title|escape:'html':'UTF-8'}"/>
                      </label>
                    </td>
                    <td>
                      <label class="control-label">
                        <input type="text" name="custom[{$lang['id_lang']}][{$key|escape:'html':'UTF-8'}][url]" value="{$page.url|escape:'html':'UTF-8'}"/>
                      </label>
                    </td>
                  </tr>
                {/foreach}
