...
class Ybc_themeconfig extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->configs = array(
                ...
                'options' => array(
                    'query' => array(
                        array(
                            ...
                            'slides' => array(20,14),
                            'widgets' => array(14, 53, 54, 72, 73, 74, 75, 76,80,81,82,83,84,85,86,87,88,89),
                            'menus' => array(2, 3, 4,5, 6,7,8,9,10,12,13,14,15),
                        ),
                        array(
                            'id_option' => 'LayoutHome2',
                            'name' => $this->l('Layout 2'),
                            'slides' => array(7, 10),
                            'widgets' => array(14, 53, 54, 70, 71, 72, 73, 74, 75, 76,80,81,82,83,84,85,86),
                            'menus' => array(1, 2, 3, 4, 5),
                        ),
                        array(
                        ...
                        array(
                            'id_option' => 'LayoutHome5',
                            'name' => $this->l('Layout 5'),
                            'slides' => array(12,13),
                            'widgets' => array(14, 53, 54, 70, 71, 72,80,81,82,83,84,85,86),
                            'menus' => array(1, 2, 3, 4, 5),
                        ),
                        array(
                            'id_option' => 'LayoutHome6',
                            'name' => $this->l('Layout 6'),
                            'slides' => array(18,19),
                            'widgets' => array(14, 53, 54, 90, 91, 72,80,81,82,83,84,85,86,87,88,89),
                            'menus' => array(2, 3, 4,5, 6,7,8,9,10,12,13,14,15),
                        ),
                    ),
                    'id' => 'id_option',
            ...
            'YBC_TC_FLOAT_CSS3' => array(
                'label' => $this->l("Enable CSS3 load animation"),
                'type' => 'switch',
                'default' => 1,
                'group' => 'ybc_tab_home',
            ),
            'YBC_FOOTER_LINK_CUSTOM' => array(
                ...
                'type' => 'textarea',
                'lang' => true,
                'default' => '<ul><li><a href="/sitemap">Sitemap</a></li><li><a href="/content/3-terms-and-conditions-of-use">Term and use</a></li><li><a href="/content/1-delivery">Delivery</a></li><li><a href="/content/2-legal-notice">Customer care</a></li></ul>',
            ...
            'YBC_TC_COPYRIGHT_TEXT' => array(
                ...
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',
                'default' => 'Copyright 2017 <a href="#">Digital Co., LTD.</a>  All rights reserved<br />Website is proudly powered by <a class="_blank" href="http://www.prestashop.com">Prestashop</a>. All images used in the demo website are for preview purpose only and not included in the download file.',
            ),
            ...
            'YBC_TC_PAYMENT_LOGO1' => array(
                'label' => $this->l('Payment logo1'),
                'type' => 'file',
                'group' => 'ybc_tab_footer',
                'default' => 'paymentlogos2.png'
            ),
            'YBC_TC_TITLE_FACE' => array(
                'label' => $this->l('Title Facebook'),
                'lang' => true,
                'type' => 'text',
                'group' => 'ybc_tab_footer',
                'default' => 'FOLLOW US ON FACEBOOK',
            ),
            'YBC_TC_LINK_FACE' => array(
                'label' => $this->l('Link facebook page'),
                'lang' => true,
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',
                'default' => 'https://www.facebook.com/prestashop/',
            ),
            'YBC_TC_SSL_IMAGE' => array(
                'label' => $this->l('Image ssl'),
                'type' => 'file',
                'group' => 'ybc_tab_footer',
                'default' => 'ssl.png',
            ),
            'YBC_TC_SSL_TEXT' => array(
                'label' => $this->l('SSL text content'),
                'lang' => true,
                'type' => 'textarea',
                'group' => 'ybc_tab_footer',
            ),
            ...
            'YBC_TC_FONT1_DATA' => array(
                ...
                'data_type' => 'font',
                'validate' => 'isString',
                'default' => 'https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700',
            ),
            ...
            'YBC_TC_FONT2_DATA' => array(
                ...
                'data_type' => 'font',
                'validate' => 'isString',
                'default' => 'https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700',
            ),
            ...
            'YBC_TC_FONT3_DATA' => array(
                ...
                'data_type' => 'font',
                'validate' => 'isString',
                'default' => 'https://fonts.googleapis.com/css?family=Montserrat:300,400,500,700',
            ),
    ...
    public function renderCss()
    {
        ...
        if ($font2 = Configuration::get('YBC_TC_FONT2_NAME')) {
            $css .= 'h1,h2,h3,h4,h5,h6,.ybc-mm-price-row,.price,.product-price ,.h1,.h2,.h3,.h4,.h5,.h6,
                h1 a,h2 a,h3 a,h4 a,h5 a,h6 a,
                h1 span,h2 span,h3 span,h4 span,h5 span,h6 span{font-family: ' . $font2 . ';}';
        }
        if ($font3 = Configuration::get('YBC_TC_FONT3_NAME')) {
            $css .= 'p{font-family: ' . $font1 . ';}';
        }
