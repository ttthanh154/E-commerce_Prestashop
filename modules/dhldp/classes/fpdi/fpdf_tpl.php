...
class FPDFTPL extends FPDIBridge
{
    ...
    public function Image(
        ...
        unset($align, $resize, $dpi, $palign, $ismask, $imgmask, $border, $fitbox, $hidden, $fitonpage, $alt, $altimgs);
