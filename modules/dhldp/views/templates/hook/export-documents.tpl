                    ...
                    <tbody>
                        {if isset($export_docs.exportdoc_positions) && count($export_docs.exportdoc_positions) > 0}
                            ...
                            <tr class="{if $smarty.foreach.position.index%2} odd{/if}">
                                <td>
                                    <textarea class="textarea-autosize" style="width: 100%;word-wrap: break-word; resize: none; height: 85px;" name="export_docs[{$export_docs.id_order_carrier|escape:'html':'UTF-8'}][ExportDocPosition][{$smarty.foreach.position.index}][description]" maxlength="256">{$product_value.description|escape:'htmlall':'UTF-8'}</textarea>
                                </td>
                                <td>
                                    <input type="text" name="export_docs[{$export_docs.id_order_carrier|escape:'html':'UTF-8'}][ExportDocPosition][{$smarty.foreach.position.index}][countryCodeOrigin]" value="{$product_value.countryCodeOrigin|escape:'htmlall':'UTF-8'}" maxlength="2">
                                </td>
                                <td>
                                    <input type="text" name="export_docs[{$export_docs.id_order_carrier|escape:'html':'UTF-8'}][ExportDocPosition][{$smarty.foreach.position.index}][customsTariffNumber]" value="{$product_value.customsTariffNumber|escape:'htmlall':'UTF-8'}" maxlength="10">
                                </td>
                                <td>
                                    <input type="text" name="export_docs[{$export_docs.id_order_carrier|escape:'html':'UTF-8'}][ExportDocPosition][{$smarty.foreach.position.index}][amount]" value="{$product_value.amount|escape:'htmlall':'UTF-8'}" maxlength="10">
                                </td>
                                <td>
                                    <input type="text" name="export_docs[{$export_docs.id_order_carrier|escape:'html':'UTF-8'}][ExportDocPosition][{$smarty.foreach.position.index}][netWeightInKG]" value="{$product_value.netWeightInKG|escape:'htmlall':'UTF-8'}" maxlength="10">
                                </td>
                                <td>
                                    <input type="text" name="export_docs[{$export_docs.id_order_carrier|escape:'html':'UTF-8'}][ExportDocPosition][{$smarty.foreach.position.index}][customsValue]" value="{$product_value.customsValue|escape:'htmlall':'UTF-8'}" maxlength="10">
                                </td>
                            </tr>
                            {/foreach}
                        {/if}
