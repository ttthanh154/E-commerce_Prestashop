...
<div class="row" id="dhldp_dhl_addit_services" style="{if !isset($addit_services.show_dhl_additional_services) || (isset($addit_services.show_dhl_additional_services) && $addit_services.show_dhl_additional_services != 1)}display: none;{/if}">
    <div class="panel">
        <div class="panel-heading">{l s='Additional services' mod='dhldp'}</div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="row form-wrapper form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control datepicker" type="text" name="addit_services[{$addit_services.id_order_carrier|escape:'html':'UTF-8'}][DayOfDelivery]"
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Return immediately' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='Service of immediatly shipment return in case of non successful delivery for product' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Service for package return' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='After the delivery of DHL Parcel same day, we provide the return of your reusable parcel at your return address. Individual extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='With the service visual check of age you can order in an uncomplicated and convenient way that your items are not handed over to children or minors. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Notification' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='Mechanism to send notifications by email after successful manifesting of shipment. Email address is email address of delivery address.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Cash On Delivery' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='Safety especially in regard to customers who placed their first order and discretion of payment handling - transaction will not show up in bank account statement of the recipient - enabled by reliable payment during parcel handing over. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Additional Insurance' mod='dhldp'}</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Ident check' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='With the service Ident-Check you order that your parcels are only delivered to the recipient in person after the identity and - where applicable - the age have been checked against the identity card. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datepicker" type="text" name="addit_services[{$addit_services.id_order_carrier|escape:'html':'UTF-8'}][IdentCheck_Ident_dateOfBirth]"
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='GoGreen' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='You will make a sustainable contribution towards climate protection by offsetting the CO2 e-emissions generated during the transportation of your items. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-lg-6">{l s='Parcel outlet routing' mod='dhldp'}</label>
						<div class="col-lg-6">
							...
							<span class="help-block">{l s='Your undeliverable item (recipient unknown
...
returning it can be avoided' mod='dhldp'}</span>
					...
					<div class="form-group">
						...
						<div class="col-lg-6">
							...
							<span class="help-block">{l s='Details can be an email-address, if not set receiver email will be used' mod='dhldp'}</span>
						</div>
					</div>
                </div>
                <div class="col-lg-6">
                    <div class="row form-wrapper form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='No Neighbour Delivery' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='With the service no neighbour delivery you can exclude an alternative delivery to the neighbour in case the recipient is not available during delivery. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-lg-6">{l s='Named Person Only' mod='dhldp'}</label>
                            <div class="col-lg-6">
                                ...
                                <span class="help-block">{l s='With the service named person only you order that your parcels are only delivered to the recipient in person or to an authorized person. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="help-block"></span>
                                <span class="help-block">{l s='This addressing version enables your customers to receive parcels round the clock, even if nobody sits at home. No extra charge.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="help-block"></span>
                                <span class="help-block">{l s=' If the customer is not at home on the day of delivery, the parcels are left with the preferred neighbour. No extra charge.' mod='dhldp'}</span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                ...
                                <span class="help-block"></span>
                                <span class="help-block">{l s='Your parcel is delivered on the desired day that you specified in advance. Extra charge in addition to the price of a parcel.' mod='dhldp'}</span>
                            </div>
                        </div>
                        {*<div class="form-group">
