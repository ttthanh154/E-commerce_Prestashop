...
class Ybc_widget extends Module
{
	...
	{	   
        ...
        $this->_hooks = array(
            ...
            array(
                'hook' => 'showRoom',
                'name' => $this->l('Hook Footer Show Room')
            ),
            array(
                'hook' => 'ybcCustom1',
            ...
            array(
                'hook' => 'ybcCustom2',
                'name' => $this->l('Banner under "Best selling products"')
            ), 
            array(
                'hook' => 'ybcCustom3',
    ...
    public function hookShowRoom()
    {
        $widgets = $this->getWidgetsByHook('showRoom', true);
        //print_r($widgets);
        $this->smarty->assign(
            array(
                'widgets' => $widgets,
                'widget_module_path' => $this->_path,
                'widget_hook' => 'footer-showroom'
            )
        );
        return $this->display(__FILE__, 'widgets.tpl');
    }
